 ...
 */
public interface NumberWaitAssert<S extends NumberWaitAssert<S, A>, A extends Number> {
   ...
   * assertThat(someOfPi).isZero();</code>
   * </pre>
   * 
   ...
   * 
   * <pre>
   * <code class='java'> int meaningOfLife = 42;
   * double someOfPi = 3.142;
   *
   * // assertions will pass
   ...
   * assertThat(longZero).isNotZero();</code>
   * </pre>
   *
   * @return this assertion object.
   * @throws AssertionError
   ...
   * 
   * <pre>
   * <code class='java'> int positive = 42;
   * int zero = 0;
   * int negative = -42;
   *
   * // assertions will pass
   ...
   * assertThat(negative).isPositive();</code>
   * </pre>
   * 
   * @return this assertion object.
   * @throws AssertionError
   ...
   * assertThat(positive).isNegative();</code>
   * </pre>
   * 
   * @return this assertion object.
   * @throws AssertionError
   ...
   *
   * // assertions will fail
   * assertThat(negative).isNotNegative();</code>
   * </pre>
   * 
   ...
   *
   * // assertions will fail
   * assertThat(positive).isNotPositive();</code>
   * </pre>
   * 
   * @return {@code this} assertion object.
   * @throws AssertionError
   ...
   * 
   * <pre>
   * <code class='java'> // these assertions succeed ...
   * assertThat(12).isBetween(10, 14);
   * assertThat(12).isBetween(12, 14);
   * assertThat(12).isBetween(10, 12);
   * 
   * // ... but this one fails
   * assertThat(12).isBetween(14, 16);</code>
   * </pre>
   * 
   * @param start
   *          the start value (inclusive), expected not to be null.
   * @param end
   ...
   *           if start value is {@code null}.
   * @throws NullPointerException
   *           if end value is {@code null}.
   * @throws AssertionError
   ...
   * assertThat(12).isBetween(12, 14);
   * assertThat(12).isBetween(10, 12);
   * assertThat(12).isBetween(16, 18);</code>
   * </pre>
   * 
   * @param start
   *          the start value (exclusive), expected not to be null.
   * @param end
   ...
   *
   * // assertion will fail
   * assertThat(8.1).isCloseTo(new Double(8.0), within(0.01));</code>
   * </pre>
   *
   * @param expected
   ...
   *
   * // assertion will fail
   * assertThat(11.0).isCloseTo(new Double(10.0), withinPercentage(5d));</code>
   * </pre>
   *
   * @param expected
   *          the given number to compare the actual value to.
