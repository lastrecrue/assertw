 ...
 *            <a href="http://bit.ly/1IZIRcY" target="_blank">Emulating 'self
 *            types' using Java Generics to simplify fluent API
...
public abstract class AbstractWaitBooleanAssert<S extends AbstractWaitBooleanAssert<S>> extends WaitAssert<S, Boolean> {
	 ...
	 * assertThat(Boolean.FALSE).isTrue();</code>
	 * </pre>
	 * 
	 ...
	 * @throws AssertionError
	 *             if the actual value is not {@code true}.
	 */
	public S isTrue() {
	 ...
	 * assertThat(Boolean.TRUE).isFalse();</code>
	 * </pre>
	 * 
	 * @return {@code this} assertion object.
	 * @throws AssertionError
	 *             if the actual value is {@code null}.
	 * @throws AssertionError
	 *             if the actual value is not {@code false}.
	 */
	public S isFalse() {
	 ...
	 * assertThat(Boolean.TRUE).isEqualTo(false);</code>
	 * </pre>
	 * 
	 * @param expected
	 ...
	 * assertThat(Boolean.FALSE).isNotEqualTo(false);</code>
	 * </pre>
	 * 
	 * @param other
	 *            the given value to compare the actual value to.
